function CharacterUI(target){	//user interface for Characters
	this.target = target;	//target Character
	this.maxHealth = target.maxHealth;
	this.health = target.health;
	this.elements = [];
	this.lastHeart = 0;

	this.cursor = new UIElement("assets/ui/cursor.png", 1, 1, {frames: 2, time: 500});	//cursor graphic
	...
	Global.uis.push(this);	//add to ui array

	this.inventorySwitch = function(){	//toggle whether or not inventory is shown (not used)
